...
export default function DenMatekPage() {
  const [lightboxOpen, setLightboxOpen] = useState(false)
  const imageSrc = '/potkejme%20se/den%20matek/att.3bhmMCb7PxiCsnfx5Y36rwsSmEd8KWwsItk6lnd3_BE.jpg'
  const imageAlt = 'Den matek na zahradě sv. Martina'
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <div className="hero-container">
            <div className="hero-content">
              ...
              <h1 style={{ fontFamily: 'Segoe UI Semibold, var(--font-display)', fontSize: 52, fontWeight: 700, color: 'var(--white)', marginBottom: 16 }}>Den matek na zahradě sv. Martina</h1>
              <p style={{ color: 'rgba(255,255,255,0.95)', fontSize: 16, fontWeight: 600, maxWidth: 520, lineHeight: 1.8 }}>Přečtěte si celý report z naší účasti na Dni matek, kde jsme představily naši vizi a rozdaly dárečky pro děti i rodiče.</p>
            </div>
            <img
              src="/LOGO_kulate.png"
              alt="Žijeme TU! logo"
        ...
        <div className="container">
          <article style={{ width: '100%', maxWidth: '100%', margin: 0, border: '1px solid var(--border)', borderRadius: 'var(--radius)', overflow: 'hidden', background: 'var(--white)', boxShadow: '0 18px 55px rgba(0,0,0,0.05)' }}>
            <div style={{ padding: '24px 24px 18px' }}>
              <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'var(--gray)', marginBottom: 10 }}>Den matek</div>
              <h2 style={{ fontFamily: 'Segoe UI Semibold, var(--font-display)', fontSize: 32, fontWeight: 700, margin: '0 0 18px' }}>Den matek na zahradě sv. Martina</h2>
              <p style={{ fontSize: 16, lineHeight: 1.8, color: 'var(--text)', margin: '0 0 16px' }}>V neděli 10. května jsme měly možnost prezentovat naše sdružení na akci Rodinného centra pořádané ke Dni matek🌸. Rozdaly jsme spoustu dárečků, probraly s vámi naše volební vize a děti nás ohromily svými znalostmi v kvízu o místních památkách🙌. Těšíme se na další spolupráci a setkání s vámi 🤝.</p>
              <p style={{ fontSize: 16, lineHeight: 1.8, color: 'var(--text)', margin: '0 0 24px' }}>Naším cílem bylo ukázat, že se může sdružení aktivně zapojit do komunitních akcí a přitom si vyslechnout potřeby obyvatel. Děkujeme všem za úsměvy, podporu a skvělé setkání.</p>
