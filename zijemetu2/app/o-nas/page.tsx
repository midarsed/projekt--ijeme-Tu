      ...
      <div style={{ background: 'var(--black)', padding: '72px 0 56px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          ...
          <div className="hero-content">
            ...
            <p style={{ color: 'rgba(255,255,255,0.95)', fontSize: 16, fontWeight: 600, maxWidth: 520, lineHeight: 1.8 }}>Jsme ženy ze Strážnice, kterým záleží na tom, aby zde bylo příjemné žít pro všechny generace.</p>
          </div>
          <img
            src="/LOGO_kulate.png"
            alt="Žijeme TU! logo"
