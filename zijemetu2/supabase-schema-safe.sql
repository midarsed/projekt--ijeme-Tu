-- ŽIJEME TU! – Bezpečný skript pro Supabase
-- Vytvoří tabulky jen pokud neexistují a smaže stará data
...
-- Smazání starých dat (ale ponechání tabulek)
TRUNCATE TABLE votes CASCADE;
TRUNCATE TABLE comments CASCADE;
TRUNCATE TABLE fb_posts CASCADE;
TRUNCATE TABLE candidates CASCADE;
TRUNCATE TABLE projects CASCADE;

-- Vložení nových ukázkových dat
